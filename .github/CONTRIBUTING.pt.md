...
Oba! Luz verde para trabalhar!

4. Faça um fork deste projeto.

5. Crie uma nova branch seguindo as [convenções recomendadas]().

6. Escreva o código e crie commits regularmente seguindo a [convenção recomendada]().
